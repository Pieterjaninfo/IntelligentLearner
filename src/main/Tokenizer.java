...
public class Tokenizer {
    ...
    private static final int maxThreshold = 1000;   // Words that occur more than this amount are considered often occurring words
    ...
    private static double CHI_SQUARE_VALUE = 1.5;         // CHI SQUARE VALUE FOR FILTERING OUT
    ...
    public static HashSet<String> chiSquareFeatureSelection(Collection<String> words) {
